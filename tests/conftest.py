...
def factor_scores():
    row_factors = np.array(
        [
            [-0.06576838, -0.19373707, 0.07098096, 0.0, 0.0],
            [0.25895841, -0.24330466, -0.03370516, 0.0, 0.0],
            [-0.38059487, -0.01065991, -0.00515575, 0.0, 0.0],
            [0.2329519, 0.05774393, 0.00330537, 0.0, 0.0],
            [-0.20108911, 0.07891126, -0.00808107, 0.0, 0.0],
        ]
    )
...
def profile_correlation():
    row = np.array(
        [
            [0.092232, 0.8003364, 0.1074316, 0.0, 0.0],
            [0.5263999, 0.4646825, 0.0089176, 0.0, 0.0],
            [0.9990329, 0.0007837, 0.0001833, 0.0, 0.0],
            [0.9419341, 0.0578762, 0.0001896, 0.0, 0.0],
            [0.8653455, 0.133257, 0.0013975, 0.0, 0.0],
        ]
    )
